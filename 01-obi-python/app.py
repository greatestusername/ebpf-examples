...
SPLUNK_INGEST_TOKEN = os.environ.get("SPLUNK_INGEST_TOKEN", "<REPLACE_ME>")
SPLUNK_REALM = os.environ.get("SPLUNK_REALM", "<REPLACE_ME>")
WORKSHOP_HOST_NAME = os.environ.get("WORKSHOP_HOST_NAME", "<REPLACE_ME>")
